          ...
          <div className="w-full flex-col justify-start lg:items-start items-center gap-10 inline-flex">
            <div className="w-full flex-col justify-start lg:items-start items-center gap-4 flex">
              ...
              <p className="text-gray-800 text-base font-normal font-poppins leading-relaxed lg:text-start text-center">
                Welcome to Mr. Barber, a premium barbershop located in the heart
                of Colombo 3. Our skilled barbers combine timeless craftsmanship
                with modern trends to deliver exceptional haircuts, styling, and
                grooming services. We pride ourselves on providing a
                personalized experience that leaves every client feeling
                confident and refreshed. Visit Mr. Barber and discover why we
                are the go-to destination for style and sophistication. The shop
                has 4 extremely skilled barbers and one owner who manages the
                business.
              </p>
            </div>
          </div>
